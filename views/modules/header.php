<header class="main-header">
	...
	<a href="home" class="logo">
		...
		<span class="logo-mini">
			...
			<img class="img-responsive" src="views/img/template/mini.jpg" style="padding: 10px" >
		...
		<span class="logo-lg">
			...
			<img class="img-responsive" src="views/img/template/logo.jpg" style="padding: 10px 0" >
